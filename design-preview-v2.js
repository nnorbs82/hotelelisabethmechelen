(() => {
  ...
  const translations = {
    en:{
      ...
      'hero.eyebrow':'A contemporary four-star stay in Mechelen','hero.title':'A modern pause in the heart of the city.','hero.body':'Designed for city breaks, business stays and unhurried weekends - with an indoor pool, quiet courtyard and Mechelen just outside.',
      ...
      'closing.eyebrow':'Your stay in Mechelen','closing.title':'Arrive. Exhale. Stay a little longer.','footer.about':'A contemporary four-star hotel in central Mechelen with 66 rooms, an indoor pool, courtyard, meeting spaces and underground parking.','footer.explore':'Explore','footer.plan':'Plan','footer.contact':'Contact','footer.preview':'Private redesign preview - the main website is unchanged.'
    },
    nl:{
      ...
      'hero.eyebrow':'Een eigentijds viersterrenverblijf in Mechelen','hero.title':'Een moderne pauze in het hart van de stad.','hero.body':'Voor citytrips, zakenverblijven en rustige weekends - met binnenzwembad, stille binnentuin en Mechelen voor de deur.',
      ...
      'manifesto.eyebrow':'Hotel Elisabeth · Mechelen','manifesto.title':'Meer dan een kamer.<br><span>Een ander ritme.</span>','manifesto.subtitle':'Hedendaags comfort met ruimte om te ademen.','manifesto.body':'Hotel Elisabeth brengt moderne kamers, ontspannen gemeenschappelijke ruimtes en een centrale ligging in Mechelen samen. Van de stad naar de binnentuin, van vergadering naar zwembad - zonder het ritme van uw verblijf te verliezen.','facts.rooms':'Kamers','facts.hotel':'Hotel','facts.pool':'Binnenzwembad','facts.location':'Centraal Mechelen',
      ...
      'closing.eyebrow':'Uw verblijf in Mechelen','closing.title':'Kom aan. Adem uit. Blijf wat langer.','footer.about':'Een eigentijds viersterrenhotel in centraal Mechelen met 66 kamers, binnenzwembad, binnentuin, vergaderruimtes en ondergrondse parking.','footer.explore':'Ontdek','footer.plan':'Plan','footer.contact':'Contact','footer.preview':'Privé redesignpreview - de hoofdwebsite is ongewijzigd.'
    },
    fr:{
      ...
      'hero.eyebrow':'Un séjour quatre étoiles contemporain à Malines','hero.title':'Une pause moderne au cœur de la ville.','hero.body':'Pour les escapades urbaines, les voyages d’affaires et les week-ends tranquilles - avec piscine intérieure, cour calme et Malines à votre porte.',
      ...
      'closing.eyebrow':'Votre séjour à Malines','closing.title':'Arrivez. Respirez. Restez un peu plus.','footer.about':'Un hôtel quatre étoiles contemporain au centre de Malines avec 66 chambres, piscine intérieure, cour, salles de réunion et parking souterrain.','footer.explore':'Explorer','footer.plan':'Planifier','footer.contact':'Contact','footer.preview':'Aperçu privé - le site principal est inchangé.'
    },
    es:{
      ...
      'hero.eyebrow':'Una estancia contemporánea de cuatro estrellas en Malinas','hero.title':'Una pausa moderna en el corazón de la ciudad.','hero.body':'Para escapadas urbanas, viajes de negocios y fines de semana tranquilos - con piscina cubierta, patio sereno y Malinas al salir.',
      ...
      'closing.eyebrow':'Tu estancia en Malinas','closing.title':'Llega. Respira. Quédate un poco más.','footer.about':'Un hotel contemporáneo de cuatro estrellas en el centro de Malinas con 66 habitaciones, piscina cubierta, patio, salas de reuniones y parking subterráneo.','footer.explore':'Explorar','footer.plan':'Planificar','footer.contact':'Contacto','footer.preview':'Vista previa privada - la web principal no ha cambiado.'
    },
    de:{
      ...
      'hero.eyebrow':'Ein zeitgemäßer Vier-Sterne-Aufenthalt in Mechelen','hero.title':'Eine moderne Pause im Herzen der Stadt.','hero.body':'Für Städtereisen, Geschäftsaufenthalte und ruhige Wochenenden - mit Innenpool, stillem Innenhof und Mechelen direkt vor der Tür.',
  ...
  document.addEventListener('keydown',event=>{if(event.key==='Escape'){closeMenu();langBox?.classList.remove('open');}});
